              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="zoom profile-user-img img-fluid img-circle" src="../../dist/<?php echo $row['imagename'];?>"
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    <a href="javascript:switchDisplay0();" class="btn btn btn-info btn-block"><i
                      ...
                      <div class="active tab-pane ">
                        <form class="form-horizontal">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                              <input type="text" class="form-control" id="inputName" Value="<?php echo $row["nom"]; ?>"
                              readonly>
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                              <textarea class="form-control" id="inputExperience" name="Message" minlength='2'
