...
$row1 = mysqli_fetch_assoc($result1);
  ...
  $query = "SELECT * from contact_etu where Email='$id' and Message='".$msg."'"; 
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <div class="float-right">
                ...
                <a href="compose.php?msg=<?php echo $row['Sender']; ?>" class="nav-link"><button type="button" class="btn btn-default"><i class="fas fa-share"></i>Répondre</button></a>
              </div>
