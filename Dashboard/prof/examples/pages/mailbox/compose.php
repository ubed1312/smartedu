...
if(!isset($_SESSION['Email4'])){
  ...
  $query = "SELECT * from contact_etu where Email='$id' and Sender='".$msg."' "; 
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-3">
              <a href="mailbox.php" class="btn btn-primary btn-block mb-3">Retour au Boite de reception</a>
...
?>
            ...
            <div class="col-md-9">
              <div class="card card-primary card-outline">
                <div class="card-header">
                  <h3 class="card-title">Message a l'Etudiant</h3>
                </div>
                <!-- /.card-header -->
                ...
                <form method="POST" action="">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <input type="text" class="form-control" id="inputName"
                              Value="<?php echo $row1['Sender']; ?>" readonly>
                  ...
                  <div class="card-footer">
                    <div class="float-right">
                      ...
                      <button type="submit" name="Send" class="btn btn-primary"><i class="far fa-envelope"></i>
                        Envoyer</button>
                    </div>
                  </div>
                  <!-- /.card-footer -->
