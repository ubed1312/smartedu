...
if(!isset($_SESSION['Email4'])){
  ...
  $query = "SELECT * from contact_adm where Email='$id' and Message='".$msg."'"; 
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <div class="float-right">
                ...
                <a href="compose1.php" class="nav-link"><button type="button" class="btn btn-default"><i class="fas fa-share"></i>Repondre</button></a>
              </div>
