...
?>
                       <a href="Map1.php"><button type="" name="Ajouter" class="btn btn-success" style='align="center"'>Ajouter votre
                          Position
                        </button></a> 
                        </br></br>
...
?>
                        ...
                        <a href="Map2.php"><button type="" name="Modifier" class="btn btn-success" style='align="center"'>&nbsp;Modifier la position &nbsp;&nbsp;      
                        </button></a> 

                 <br><br>
                        <button type="submit" name="Supp" class="btn btn-danger" style='align="center"' onclick="archiveFunction(this.id)">Supprimer la position        
                        </button>
...
Swal.fire({
  title: 'Etes-vous sur?',
  text: "Cette Position sera supprimée!",
  icon: 'warning',
  ...
  swal.fire({
    icon: "success",
    title: "Bien .",
    text: "Position supprimée",
  })
});
setTimeout(function(){location.href="Map.php"} , 2000);  
