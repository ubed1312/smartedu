                ...
                <div class="card-footer"> <br><br>
                  ...
                  <div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
                       ...
                       <a href="Map.php"> <button type="" name="Retour" class="btn btn-success" style='align="center"'>Retour
                        </button></a>

                         <br> <br>
<form action='' method='post'>
                        <button type="submit" name="Supprimer" class="btn btn-danger" style='align="center"'>Retour (Sans Enregistrer)         
                        </button>
...
//connexion au serveur
   ...
   $sql0 = "UPDATE listeprof SET lat=NULL , lng=NULL where ID='$id' ";
